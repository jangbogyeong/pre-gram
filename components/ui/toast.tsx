...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed z-[100] flex max-h-screen w-full flex-col-reverse p-4 sm:bottom-0 sm:right-0 sm:top-auto sm:flex-col-reverse md:max-w-[320px]",
      className,
    )}
    {...props}
  />
  ...
  return (
    <ToastPrimitives.Root
      ...
      className={cn(
        ...
        className,
        // 토스트 크기를 작게 만드는 스타일 추가
        "text-sm p-2 pr-5 mb-1 max-w-[280px]",
      )}
      {...props}
    />
  )
